...
DB_PATH = WORKSPACE_DIR / "data" / "district_malnutrition_eda.db"


NFHS4_PATH = PROJECT_ROOT / "NFHS-4.csv"
NFHS5_PATH = PROJECT_ROOT / "NFHS-5.csv"
AGRI_PATH = PROJECT_ROOT / "AgricultureStatistics.csv"
HMIS_PATH = PROJECT_ROOT / "HMIS (2017-18,2019-20).csv"
JJM_PATH = PROJECT_ROOT / "JalJeevanMission.csv"
